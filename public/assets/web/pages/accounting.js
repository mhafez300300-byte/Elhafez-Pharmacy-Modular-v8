...
function trialTable(items) { if (!items.length)
    ...
    (t.querySelector('tbody')).append(h('tr', {}, h('td', {}, x.code), h('td', {}, x.nameAr), h('td', {}, x.type), h('td', {}, money(x.debit)), h('td', {}, money(x.credit)), h('td', {}, money(x.balance)))); return t; }
...
function journalTable(items) { if (!items.length)
    ...
    (t.querySelector('tbody')).append(h('tr', {}, h('td', {}, e.postingDate ?? new Date(e.createdAt).toLocaleDateString('ar-EG')), h('td', {}, e.description), h('td', {}, `${e.referenceType} / ${e.referenceId}`), h('td', {}, money(debit)), h('td', {}, money(credit))));
} return t; }
