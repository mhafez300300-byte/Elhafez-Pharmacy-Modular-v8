(function(root,factory){
  ...
  if(root)root.ElhafezFinance=api;
  ...
  function returnAmounts(line,qty){
  ...
  return{EPS,n,money,taxRate,computeSale,returnAmounts,accountForPayment};
});
