...
export type PurchaseOrderView=Readonly<{id:string;number:string;tenantId:string;branchId:string;supplierId:string;userId:string;status:'open'|'partial'|'received'|'cancelled';createdAt:string;lines:ReadonlyArray<PurchaseOrderLineView>}>;
...
export interface PurchaseContract{
 ...
 listOrders(tenantId:string,limit?:number):Promise<PurchaseOrderView[]>;
